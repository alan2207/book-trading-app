...
class Header extends React.Component {
    ...
    renderLinks() {
        if(this.props.authenticated) {
            return [
            <Link key={5} className="navbar-item" to="/dashboard"><span className="icon"><i className="fa fa-tachometer" aria-hidden="true"></i></span>Dashboard</Link>,
        ...
        return (
            <nav className="navbar nav-fixed-top">
                <div className="navbar-brand">
                    <Link to="/" className="navbar-item">Book Trading</Link >
